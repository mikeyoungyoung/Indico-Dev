...
"""
    ...
    # submissions_df.filter(submissions_df.deleted == False).show(5)
    # complete_submissions = submissions_df.filter(submissions_df.workflowId == 701).filter(submissions_df.deleted == False)
    ...
    # submissions_df.write.parquet('./submissions_raw')
